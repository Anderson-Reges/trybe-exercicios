...
console.log('\n A AREA DE UM LOSANGO:');
console.log(`- D = 32cm e d = 18c ${Ex.getLosangArea(32, 18)}cm`);
console.log(`- D = 200cm e d = 50cm ${Ex.getLosangArea(200, 50)}cm`);
console.log(`- D = 75cm e d = 25cm ${Ex.getLosangArea(75, 25)}cm`);
console.log('\n A AREA DE UM CIRCULO:');
console.log(`- R = 25cm ${Ex.getCircleArea(25)}cm`);
console.log(`- R = 100cm ${Ex.getCircleArea(100)}cm`);
console.log(`- R = 12,5cm ${Ex.getCircleArea(12.5)}cm`);
