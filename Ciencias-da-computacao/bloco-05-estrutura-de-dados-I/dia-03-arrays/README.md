...
Nesse dia foi passado o começo do conteudo sobre estrutura de dados focado no Array/Lista e como funciona essa estrutura na memoria e na linguagem `Python`, nesse dia eu fui capaz de:
